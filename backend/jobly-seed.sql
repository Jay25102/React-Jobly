...
VALUES ('bauer-gallagher', 'Bauer-Gallagher', 862,
       ...
       ('jackson-sons', 'Jackson and Sons', 649,
        'President couple political sit create.', '/logos/logo4.jpg'),
       ...
       ('taylor-yu-lee', 'Taylor, Yu and Lee', 226,
        'Down bag serve. Officer season company.', '/logos/logo2.jpg'),
       ...
       ('garcia-ray', 'Garcia-Ray', 217,
        'Laugh low follow fear. Politics main size fine.', '/logos/logo2.jpg'),
       ...
       ('jackson-davila-conley', 'Jackson, Davila and Conley', 813,
        'Consider with build either.', '/logos/logo4.jpg'),
       ...
       ('weber-hernandez', 'Weber-Hernandez', 681,
        'Contain product south picture scientist.', '/logos/logo4.jpg');
